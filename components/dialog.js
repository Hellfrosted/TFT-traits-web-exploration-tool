...
(function initializeDialogComponent() {
    const ns = window.TFTRenderer = window.TFTRenderer || {};
    const dialogNs = ns.dialog = ns.dialog || {};
    ...
    dialogNs.showAlert = showAlert;
    dialogNs.showConfirm = showConfirm;
    dialogNs.showDialog = showDialog;
})();
