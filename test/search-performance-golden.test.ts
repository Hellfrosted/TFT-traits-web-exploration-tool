...
const { digestResults } = require('../tools/benchmark-search.js');
...
describe('search performance golden scenario', () => {
    it('preserves representative large-search results while optimizing', () => {
        ...
        assert.equal(digestResults(results), 'fec77ea553e8a3f0e2e083ddce75dfb884128bb881c9e5fe9ff556bd123dbde3');
    });
});
